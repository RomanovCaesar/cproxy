...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/RomanovCaesar/cproxy/constant.Version=$(VERSION)" \
		-X "github.com/RomanovCaesar/cproxy/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
